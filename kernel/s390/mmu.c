...
static int s390_turn_off(struct mmu_dev *dev) {
    return 0;
}

static int s390_map(struct mmu_dev *dev, void *phys, void *virt) {
    return 0;
}

static int s390_unmap(struct mmu_dev *dev) {
    return 0;
}

static int s390_virt2phys(struct mmu_dev *dev) {
    return 0;
}
    
static int s390_set_vspace(struct mmu_dev *dev, void *data) {
    return 0;
}

static void *s390_get_vspace(struct mmu_dev *dev) {
    return NULL;
}

struct mmu_dev s390_mmu = {
    .turn_on = &s390_turn_on,
