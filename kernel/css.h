...
extern int CssStartChannel(struct css_schid schid, struct css_orb *schib);
extern int CssStoreChannel(struct css_schid schid, void *schib);
extern int CssModifyChannel(struct css_schid schid, struct css_schib *schib);
extern int CssTestChannel(struct css_schid schid, struct css_irb *schib);
